...
\begin{document}
	...
	\section{Symmetries}
	\begin{itemize}
		\item A graph is symmetrical about the y-axis if (a,b) is on the graph whenever (-a,-b) is. \includegraphics[width=0.2\linewidth]{basic-parab}
		\item A graph is symmetrical about the x-axis if (a,b) is on the graph whenever (a,-b) is. \includegraphics[width=0.2\linewidth]{vert-symmetry}
		\item A graph is symmetrical about the origin if (a,b) is on the graph whenever (-a,-b) is. \includegraphics[width=0.2\linewidth]{unit-circle}
	\end{itemize}
